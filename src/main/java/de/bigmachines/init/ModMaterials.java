...
public class ModMaterials {
	...
	//LAYERS
		...
		public static RegistryObject<Block> glass_layers = ModBlocks.BLOCKS.register("glass_layers", () -> new LayerBlock(AbstractBlock.Properties.of(Material.GLASS).strength(0.3F).sound(SoundType.GLASS).noOcclusion().setAllowsSpawn((BlockState state, IBlockReader reader, BlockPos pos, EntityType<?> entity) -> false).setOpaque((BlockState state, IBlockReader reader, BlockPos pos) -> false).setSuffocates((BlockState state, IBlockReader reader, BlockPos pos) -> false).setBlocksVision((BlockState state, IBlockReader reader, BlockPos pos) -> false)));
		//NORMAL Items
