...
public class ElementEntity extends Element {
	...
	public ElementEntity(GuiContainerBase gui, int posX, int posY) {
		super(gui, posX, posY);
	}
	...
	public void drawEntityOnScreen(
			...
			float renderYawOffset, float rotationYaw, float rotationPitch, float prevRotationYawHead, float rotationYawHead,
